...
import type { BeamsHub, BeamsHubInterface } from "../BeamsHub";
...
export class BeamsHub__factory {
  static readonly abi = _abi;
  static createInterface(): BeamsHubInterface {
    return new utils.Interface(_abi) as BeamsHubInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BeamsHub {
    return new Contract(address, _abi, signerOrProvider) as BeamsHub;
  }
}
